...
//      });
    ...
    case "l0":
      ...
      break;
    default:
      var execcmdtx = 'tx1=`cat /sys/class/net/wlan0/statistics/tx_bytes`; sleep 1; tx2=`cat /sys/class/net/'+ opts.nic +'/statistics/tx_bytes`; tx_bps=$((($tx2*8)-($tx1*8))); tx_kbps=$(($tx_bps / 1024)); echo $tx_kbps;'
